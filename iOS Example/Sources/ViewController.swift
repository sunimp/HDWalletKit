...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        do {
            ...
            print("==> HD Private key: \(privateKey.raw.sw.hex)")
            print("==> HD Public key: \(privateKey.publicKey(compressed: true).raw.sw.hex)")
    ...
    func generateAndCheckPublicKeys(privateKey: HDPrivateKey) throws {
        for i in 0..<20 {
            ...
            print("==> Private key: \(childKey.raw.sw.hex)")
